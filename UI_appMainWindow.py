...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_6.setGeometry(QtCore.QRect(80, 0, 275, 200))
        ...
        self.txt_PinholeX = QtWidgets.QPlainTextEdit(self.gridLayoutWidget_6)
        self.txt_PinholeX.setMinimumSize(QtCore.QSize(90, 25))
        self.txt_PinholeX.setMaximumSize(QtCore.QSize(90, 25))
        self.txt_PinholeX.setTabChangesFocus(True)
        self.txt_PinholeX.setObjectName("txt_PinholeX")
        self.gridLayout_6.addWidget(self.txt_PinholeX, 4, 0, 1, 1)
        self.label_PinholeX = QtWidgets.QLabel(self.gridLayoutWidget_6)
        self.label_PinholeX.setObjectName("label_PinholeX")
        self.gridLayout_6.addWidget(self.label_PinholeX, 4, 1, 1, 1)
        self.txt_PinholeY = QtWidgets.QPlainTextEdit(self.gridLayoutWidget_6)
        self.txt_PinholeY.setMinimumSize(QtCore.QSize(90, 25))
        self.txt_PinholeY.setMaximumSize(QtCore.QSize(90, 25))
        self.txt_PinholeY.setTabChangesFocus(True)
        self.txt_PinholeY.setObjectName("txt_PinholeY")
        self.gridLayout_6.addWidget(self.txt_PinholeY, 5, 0, 1, 1)
        self.label_PinholeY = QtWidgets.QLabel(self.gridLayoutWidget_6)
        self.label_PinholeY.setObjectName("label_PinholeY")
        self.gridLayout_6.addWidget(self.label_PinholeY, 5, 1, 1, 1)
        ...
        self.radioButton_CamDMD2ImageMask = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.radioButton_CamDMD2ImageMask.setChecked(True)
        self.radioButton_CamDMD2ImageMask.setAutoExclusive(True)
        self.radioButton_CamDMD2ImageMask.setObjectName("radioButton_CamDMD2ImageMask")
        self.gridLayout.addWidget(self.radioButton_CamDMD2ImageMask, 4, 0, 1, 1)
        self.radioButton_CamDMD1ImageMask = QtWidgets.QRadioButton(self.gridLayoutWidget)
        self.radioButton_CamDMD1ImageMask.setAutoExclusive(True)
        self.radioButton_CamDMD1ImageMask.setObjectName("radioButton_CamDMD1ImageMask")
        self.gridLayout.addWidget(self.radioButton_CamDMD1ImageMask, 4, 1, 1, 1)
        ...
        self.radioButton_CamDMD2DMDMask = QtWidgets.QRadioButton(self.gridLayoutWidget_2)
        self.radioButton_CamDMD2DMDMask.setChecked(True)
        self.radioButton_CamDMD2DMDMask.setAutoExclusive(True)
        self.radioButton_CamDMD2DMDMask.setObjectName("radioButton_CamDMD2DMDMask")
        self.gridLayout_2.addWidget(self.radioButton_CamDMD2DMDMask, 0, 0, 1, 2)
        ...
        self.radioButton_CamDMD1DMDMask = QtWidgets.QRadioButton(self.gridLayoutWidget_2)
        self.radioButton_CamDMD1DMDMask.setAutoExclusive(True)
        self.radioButton_CamDMD1DMDMask.setObjectName("radioButton_CamDMD1DMDMask")
        self.gridLayout_2.addWidget(self.radioButton_CamDMD1DMDMask, 0, 2, 1, 2)
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(930, 390, 131, 273))
        ...
        self.btn_CamDMD1DMD = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.btn_CamDMD1DMD.setObjectName("btn_CamDMD1DMD")
        self.verticalLayout.addWidget(self.btn_CamDMD1DMD)
        self.btn_CamDMD2DMD = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.btn_CamDMD2DMD.setObjectName("btn_CamDMD2DMD")
        self.verticalLayout.addWidget(self.btn_CamDMD2DMD)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_SlitSeparation.setText(_translate("MainWindow", "Slit Separation (px)"))
        self.label_SlitWidth.setText(_translate("MainWindow", "Slit Width (px)"))
        ...
        self.label_PinholeRadius.setText(_translate("MainWindow", "Pinhole Radius (px)"))
        self.label_NumberOfPinholes.setText(_translate("MainWindow", "Number of Pinholes"))
        self.label_PinholePitch.setText(_translate("MainWindow", "Pinhole Pitch (px)"))
        self.txt_PinholeRadius.setPlainText(_translate("MainWindow", "0"))
        self.label_PinholeX.setText(_translate("MainWindow", "Pinhole Position X (px, 0 = centre)"))
        self.txt_PinholeX.setPlainText(_translate("MainWindow", "0"))
        self.label_PinholeY.setText(_translate("MainWindow", "Pinhole Position Y (px, 0 = centre)"))
        self.txt_PinholeY.setPlainText(_translate("MainWindow", "0"))
        ...
        self.radioButton_CamDMD2ImageMask.setText(_translate("MainWindow", "CamDMD2 Mask"))
        self.radioButton_CamDMD1ImageMask.setText(_translate("MainWindow", "CamDMD1 Mask"))
        ...
        self.radioButton_CamDMD2DMDMask.setText(_translate("MainWindow", "CamDMD2 Mask"))
        ...
        self.radioButton_CamDMD1DMDMask.setText(_translate("MainWindow", "CamDMD1 Mask"))
        ...
        self.btn_CamDMD1DMD.setText(_translate("MainWindow", "CamDMD1"))
        self.btn_CamDMD2DMD.setText(_translate("MainWindow", "CamDMD2"))
